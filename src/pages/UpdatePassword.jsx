                    ...
                    <div>
                        {!resetComplete ? (
                            <form onSubmit={handleOnSubmit}>
                                ...
                                <label>
                                    ...
                                    <div className="relative">
                                        <input
                                            ...
                                            className='px-2 py-2 pr-10 bg-richblack-800 rounded-md border border-b-richblack-400 text-white text-sm w-full'
                                        />
                                ...
                                <button
                                    type='submit'
                                    className='w-full mt-6 text-center py-[12px] px-[24px] rounded-md text-sm flex items-center 
                                    gap-2 justify-center bg-yellow-50 text-black'
                                >
                                    Reset Password
                                </button>
                            </form>
